    ...
    public void get10(){
     ...
     // Do Assertion
        response.then()
                ...
                .body("meta.pagination.limit",equalTo(10),
                        ...
                        "data.name",hasItems("Pramila Verma", "Agneya Gupta I", "Diksha Shukla" ));

        //   The female users are less than or equals to male users
        //  (Kadın kullanıcı sayısı erkek kullanıcı sayısından küçük yada eşit olamlı)
        // Kadın ve erkek sayılarını karşlaştıralm
     ...
     List<String> genderList = jsonPath.getList("data.gender");
      ...
      int kadinSayisiGroovy =  jsonPath.getList("data.findAll{it.gender=='female'}").size();
        ...
        //Groovy kullanarak gender değeri "male" olan elemenları filtreliyoruz. erkek sayısını buluyoruz.
